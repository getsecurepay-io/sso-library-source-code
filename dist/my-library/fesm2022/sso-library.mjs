...
class AppSetupService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: AppSetupService, deps: [{ token: i1.HttpClient }, { token: CookieService }], target: i0.ɵɵFactoryTarget.Injectable }); }
...
class SSOAuthService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.12", ngImport: i0, type: SSOAuthService, deps: [{ token: i1.HttpClient }, { token: CookieService }], target: i0.ɵɵFactoryTarget.Injectable }); }
...
export { AppSetupService, MyLibraryComponent, MyLibraryModule, MyLibraryService, SSOAuthService };
